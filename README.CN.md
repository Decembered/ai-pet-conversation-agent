...
本仓库正在基于 Open-LLM-VTuber `1.2.1` 开发情感化 AI 桌宠。当前基础版本已经加入安全“小太阳”人格、真实宠物状态、SQLite 持久化以及 `get_pet_state` / `feed_pet` MCP 工具。

开发和验证方法见 [SLAI Pet 基础功能说明](doc/SLAI_PET_BASIC_SETUP.md)。未完成能力和当前边界以该说明为准。
