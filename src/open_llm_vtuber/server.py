...
from .pet.routes import init_pet_routes
    ...
    def __init__(self, config: Config, default_context_cache: ServiceContext = None):
        ...
        self.app.include_router(
            init_client_ws_route(
                ...
                pet_runtime=self.pet_runtime,
            ),
        )
        self.app.include_router(init_pet_routes(self.pet_runtime))
        self.app.include_router(
        ...
        self.app.mount(
            "/pet-artifacts",
            CORSStaticFiles(directory=str(self.pet_runtime.artifacts.root)),
            name="pet-artifacts",
        )
        ...
        self.app.mount(
            "/pet-demo",
            CORSStaticFiles(directory="pet_demo", html=True),
            name="pet_demo",
        )
